...
{
    public void writeToFile(String prefix, List<String> lines) throws IOException
    {
        File file = createEmptyFile( prefix );
    ...
    private File createEmptyFile(String prefix) throws IOException
    {
        String path = getOutputDir() + generateFileName( prefix );
